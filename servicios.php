...
<html>
<head>
<title>Fly Smart | Servicios</title>
<link rel="stylesheet" type="text/css" href="/css/styles_servicios.css">
</head>
<body>
<div class="container">
    <h1>Fly Smart | Servicios</h1>
    <ul class="options">
        <li><a href="consulta.php">Consultar Información</a></li>
        <li><a href="crearReserva.php">Hacer Reservación</a></li>
    </ul>
